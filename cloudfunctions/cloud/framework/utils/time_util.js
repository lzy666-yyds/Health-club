...
module.exports = {
	fmtDateCHN,//时间格式化为年月日点分
	simpleDate,//日期简化，去掉多余的前缀0

	getTimeLeft,

	getNowMinTimestamp,//// 取得分钟时间戳

	getMonthFirstTimestamp,
	getMonthLastTimestamp,

	getDayFirstTimestamp,//获取某天0点
	...
	getFirstOfWeek,//获取当前日期所在周一 输入和返回格式=yyyy-mm-dd
	getLastOfWeek,//获取当前日期所在周一 输入和返回格式=yyyy-mm-dd
	getFirstOfMonth,//获取当前日期所在月第一天 输入和返回格式=yyyy-mm-dd
	getLastOfMonth//获取当前日期所在月最后一天 输入和返回格式=yyyy-mm-dd
}